...
public class ContactUsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.fragment_contact_us, container,
				false);

		tv = (ShimmerTextView) rootView.findViewById(R.id.shimmer_tv);
		webLinkTextView = (TextView) rootView
				.findViewById(R.id.webLinkTextView);
		...
		emailTextView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra(Intent.EXTRA_EMAIL,
						new String[] { "info@bookmyskills.com" });
	...
	private void addInformation() {
		...
		message.append("\n\nSystem Report Log : ").append(curDate.toString())
				.append('\n').append('\n');
