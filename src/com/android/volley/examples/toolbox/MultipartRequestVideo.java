...
public class MultipartRequestVideo extends Request<JSONObject>
{
	...
	public MultipartRequestVideo(String url, Response.ErrorListener errorListener, Response.Listener<JSONObject> listener,
