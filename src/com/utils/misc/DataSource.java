...
public class DataSource {
	...
	public DataSource(Context context) {
		...
		mDataSource.add(itemFromType(DrawableProvider.SAMPLE_ROUND));// SAMPLE_RECT));
		mDataSource.add(itemFromType(DrawableProvider.SAMPLE_ROUND));// SAMPLE_ROUND_RECT));
		mDataSource.add(itemFromType(DrawableProvider.SAMPLE_ROUND));// SAMPLE_ROUND));
		mDataSource.add(itemFromType(DrawableProvider.SAMPLE_ROUND));// SAMPLE_RECT_BORDER));
		mDataSource.add(itemFromType(DrawableProvider.SAMPLE_ROUND));// SAMPLE_ROUND_RECT_BORDER));
		mDataSource.add(itemFromType(DrawableProvider.SAMPLE_ROUND));
		mDataSource.add(itemFromType(DrawableProvider.SAMPLE_ROUND));// SAMPLE_MULTIPLE_LETTERS));
		mDataSource.add(itemFromType(DrawableProvider.SAMPLE_ROUND));// SAMPLE_FONT));
		mDataSource.add(itemFromType(DrawableProvider.SAMPLE_ROUND));// SAMPLE_SIZE));
		mDataSource.add(itemFromType(DrawableProvider.SAMPLE_ROUND));// SAMPLE_ANIMATION));
		mDataSource.add(itemFromType(DrawableProvider.SAMPLE_ROUND));// SAMPLE_MISC));
	}
