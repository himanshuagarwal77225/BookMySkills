...
public class MDTintHelper {
	...
	public static void setTint(RadioButton radioButton, int color) {
		ColorStateList sl = new ColorStateList(new int[][] {
				...
				DialogUtils.resolveColor(radioButton.getContext(),
						R.attr.colorControlNormal), color });
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
			radioButton.setButtonTintList(sl);
		} else {
//			Drawable d = DrawableCompat
//					.wrap(ContextCompat.getDrawable(radioButton.getContext(),
...
//			Drawable progressDrawable = DrawableCompat.wrap(seekBar
//					.getProgressDrawable());
//			seekBar.setProgressDrawable(progressDrawable);
//			DrawableCompat.setTintList(progressDrawable, s1);
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
//				Drawable thumbDrawable = DrawableCompat
//						.wrap(seekBar.getThumb());
...
//				seekBar.setThumb(thumbDrawable);
	...
	public static void setTint(EditText editText, int color) {
		ColorStateList editTextColorStateList = createEditTextColorStateList(
				editText.getContext(), color);
	...
	public static void setTint(CheckBox box, int color) {
		ColorStateList sl = new ColorStateList(new int[][] {
				new int[] { -android.R.attr.state_checked },
				new int[] { android.R.attr.state_checked } }, new int[] {
				DialogUtils.resolveColor(box.getContext(),
						R.attr.colorControlNormal), color });
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
			box.setButtonTintList(sl);
		} else {
			// Drawable drawable =
			// DrawableCompat.wrap(ContextCompat.getDrawable(
