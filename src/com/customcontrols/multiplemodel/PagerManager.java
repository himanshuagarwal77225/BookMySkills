...
import com.customcontrols.multiplemodel.ItemEntity;

/**
 * Created by chenupt@gmail.com on 2014/8/9. Description : Manage fragments to
 * be used by adapter.
 */
	...
	public PagerManager addFragments(List<ItemEntity> dataList) {
		try {
			for (ItemEntity itemEntity : dataList) {
				Fragment fragment = (Fragment) itemEntity.getModelView()
						.newInstance();
