...
/**
 * Created by chenupt@gmail.com on 2015/2/14. Description : AndroidAnnotation
 * list adapter
 */
public class AAModelListAdapter extends ModelListAdapter {
	...
	@Override
	public View modelNewInstance(Context context, Class<?> owner)
			throws Exception {
		return (View) owner.getMethod("build", new Class[] { Context.class })
